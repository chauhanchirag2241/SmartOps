...
using SmartOps.Infrastructure.Common.Excel;
...
using SmartOps.Infrastructure.Modules.Jobs;
using SmartOps.Infrastructure.Modules.Jobs.Services;
...
using SmartOps.Infrastructure.Modules.FeeMaster;
...
public static class InfrastructureServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddSmartOpsDatabaseInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSmartOpsHangfire(configuration);
