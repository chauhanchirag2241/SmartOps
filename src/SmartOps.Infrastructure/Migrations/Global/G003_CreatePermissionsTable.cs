    ...
    public override void Up()
    {
        if (!Schema.Schema(DatabaseConfig.Schema_Global).Table(DatabaseConfig.TableMenus).Exists())
        {
            ...
            Create.UniqueConstraint("uq_menus_code_application")
                .OnTable(DatabaseConfig.TableMenus).WithSchema(DatabaseConfig.Schema_Global)
...
""");
    ...
    public override void Down()
    {
        ...
        Delete.UniqueConstraint("uq_menus_code_application")
            .FromTable(DatabaseConfig.TableMenus).InSchema(DatabaseConfig.Schema_Global);
