...
[Tags("Global")]
[Migration(15, "Global — seed homework menu")]
public sealed class G015_SeedHomeworkMenu : Migration
{
...
WHERE lower(trim(r.name)) = lower(trim('{RoleNames.SmartOpsAdmin}')) AND m.code = '{MenuCodes.Homework}'
  AND NOT EXISTS (
