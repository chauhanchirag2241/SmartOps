...
[Tags("Global")]
[Migration(33, "Global — seed fee management menus")]
public sealed class G033_SeedFeeMenus : Migration
{
    ...
    [
        (FeeManagementParentId, "Fee Management", MenuCodes.FeeManagement, null, null, "payments", 27),
        (Guid.Parse("10000000-0000-0000-0000-000000000081"), "Fee Master", MenuCodes.FeeMaster, FeeManagementParentId, "/fees/master", "receipt_long", 81),
    ];
